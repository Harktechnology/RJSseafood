            ...
            <div class="screen-row">
                    ...
                    <div class="screen-row ">
                       ...
                       <div class="cell-left  ">
                           <div class="cell-left pad-lft-15 ">
                            <input type="text" class="form-control isc-frm-cont-mb-res" id="txt-
              ...
              <input type="text" class="form-control" id="Daterangepicker" placeholder="Due On" value="Due On">
                 ...
                 <div class="screen-row">
                        ...
                        <div class="screen-row">
                            <table class="isc-table-read-optimal " id="EMPLOYEE">
                                                <thead>
                                                    <tr>
                                                        
                                                        <th style="width: 11%;" class="header">Employee Name
                                                        </th>
                                                      
                                                        <th style="width: 13.5%;" class="header">DOB
                                                        </th>
