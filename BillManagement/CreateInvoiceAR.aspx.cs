...
{
    public partial class CreateInvoiceAR : System.Web.UI.Page
    {
        ...
        public static string GetFilterData()
        {
            ...
            try
            {
                data = CreateInvoiceLogic.FetchCreateInvoiceMasterData(Login.Connection);
        ...
        [System.Web.Services.WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static int SaveInvoice(InvoiceObjects objInvoice)
        {
            DataSet ds = new DataSet();
            string data = string.Empty;
            int postStatus = 0;
            try
            {
                postStatus = CreateInvoiceLogic.InsertInvoice(objInvoice, Login.Connection);
        ...
        public static string GetInvoicdetails(int InvoiceId)
        {
            ...
            try
            {
                data = CreateInvoiceLogic.GetInvoInVoicdetails(InvoiceId, Login.Connection);
        ...
        public static int UpdateInvoicedata(CreateBillobj objInvoice)
        {
            ...
            try
            {
                postStatus = CreateInvoiceLogic.UpdateInvoice(objInvoice, Login.Connection);
