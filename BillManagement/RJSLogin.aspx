    ...
    <div class="screen-row">
        <div class="isc-50per">
            <div class="isc-left-log-cont">
                ...
                <h5>Copyright © Hark Technologyes 2021 | Privacy Policy | Terms & Conditions</h5>
            </div>
                    ...
                    <div class="isc-login-details-con">
                        ...
                        <div class="isc-login-details-inner-con mar-top-15">
                            <label>Username or Email </label>
                              <asp:TextBox type="text" runat="server" ID="login_userName" CssClass="placeholder-no-fix"  autocomplete="off" placeholder="Username or Email"  name="Email" />
                            <%--<input type="text">--%>
